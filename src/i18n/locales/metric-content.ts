...
export const metricSiteContent: SiteContent = {
  ...
  ui: {
    ...
    consentPrefix: "I agree to the processing of my personal data as described in the",
    consentLinkLabel: "Privacy Policy",
    consentSuffix: "",
    consentRequired: "Please accept the Privacy Policy to send your request",
    captchaRequired: "Please complete the captcha to send your request",
    task: "Task:",
    solution: "Solution:",
  ...
  projectBrief: {
    ...
    subtitle:
      "Answer a few quick questions so we can understand your goals and recommend the right solution. We usually respond within one business day.",
    nameLabel: "Your name",
    ...
    aboutPlaceholder:
      "Briefly describe your product, current challenge, and the result you would like to achieve.",
